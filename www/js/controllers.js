...
.controller('LoginCtrl', function($scope, $state, $templateCache, $q, $rootScope) {
	...
	$scope.user.email = "demo@th-properties.com";
		...
		cordova.plugins.email.isAvailable(
			function (isAvailable) {
				...
				cordova.plugins.email.open({
					to:      'ed@ezymekah.com',
					cc:      'intelligenethics@gmail.com',
					// bcc:     ['7appsinc@gmail.com', 'ihaidy96@gmail.com'],
					subject: 'EzyMekahApp Support',
					body:    'How are you? Greetings from EzyMekahApp'
				});
			}
		);
	};
...
.controller('SettingsCtrl', function($scope, $ionicActionSheet, $state) {
	...
	$scope.showLogOutMenu = function() {
		...
		var hideSheet = $ionicActionSheet.show({
			...
			titleText: 'Are you sure you want to logout? Before you dismiss us please save all your contents.',
			cancelText: 'Cancel',
			cancel: function() {
				// add cancel code..
			},
